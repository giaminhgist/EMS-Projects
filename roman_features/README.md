# roman_features/ — saccade direction frequencies & ambient/focal K-index

Isolated experiment for two new hand-crafted eye-movement feature
...
## 1. Saccade inference and conventions

The EMS release contains fixations only. Every
...
## 2. K-index definition and reference statistics
...
## 4. Ablation matrix and hypotheses
...
| A1 | base45_freq20 | 63 | 
| A2 | base45_k | 46 | 
| A3 | base45_freq20_k | 64 | 
| A4 | base45_freq10 | 81 | 


## 5. Reproduction commands (exact)
